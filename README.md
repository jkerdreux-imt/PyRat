...
3) Then, run the following command to create a PyRat workspace in the current directory and install it in editable mode:
```sh
...
```sh
python -c "import pyrat; pyrat.generate_documentation('pyratws')"`
```
